  ...
  _createClass(ReactCalendarTimeline, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      var visibleTimeStart = nextProps.visibleTimeStart,
          ...
          lineHeight = nextProps.lineHeight; // This is a gross hack pushing items and groups in to state only to allow
      // For the forceUpdate check

      var derivedState = {
        items: items,
        groups: groups,
        lineHeight: lineHeight // if the items or groups have changed we must re-render

      };
      var forceUpdate = items !== prevState.items || groups !== prevState.groups || lineHeight !== prevState.lineHeight; // We are a controlled component
