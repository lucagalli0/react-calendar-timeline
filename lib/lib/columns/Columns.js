...
function (_Component) {
  ...
  _createClass(Columns, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      return !(nextProps.canvasTimeStart === this.props.canvasTimeStart && nextProps.canvasTimeEnd === this.props.canvasTimeEnd && nextProps.canvasWidth === this.props.canvasWidth && nextProps.lineCount === this.props.lineCount && nextProps.minUnit === this.props.minUnit && nextProps.timeSteps === this.props.timeSteps && nextProps.height === this.props.height && nextProps.verticalLineClassNamesForTime === this.props.verticalLineClassNamesForTime && nextProps.showWorkingHours === this.props.showWorkingHours);
    }
  }, {
    key: "render",
    value: function render() {
      var _this$props = this.props,
          ...
          showWorkingHours = _this$props.showWorkingHours;
      ...
      (0, _calendar.iterateTimes)(canvasTimeStart, canvasTimeEnd, minUnit, timeSteps, function (time, nextTime) {
        ...
        if (showWorkingHours) {
          if (minUnit !== 'hour' || minUnit === 'hour' && firstOfType) lines.push(_react["default"].createElement("div", {
          ...
          }));else if (minUnit === 'hour' && time.hours() % 3 === 0) lines.push(_react["default"].createElement("div", {
            key: "line-".concat(time.valueOf()),
            className: classNames,
            style: {
              pointerEvents: 'none',
