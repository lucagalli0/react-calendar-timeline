...
function (_Component) {
  ...
  function Item(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleMouseEnter", function (e) {
      if (_this.props.onItemMouseEnter) {
        _this.props.onItemMouseEnter(_this.props.item, e);
      }
    });

    _defineProperty(_assertThisInitialized(_this), "handleMouseLeave", function (e) {
      if (_this.props.onItemMouseLeave) {
        _this.props.onItemMouseLeave(_this.props.item, e);
      }
    });
