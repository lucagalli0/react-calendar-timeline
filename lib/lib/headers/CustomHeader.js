...
var getHeaderIntervals = function getHeaderIntervals(_ref) {
...
function (_React$Component) {
  ...
  function CustomHeader(_props) {
    ...
    var intervals = getHeaderIntervals({
  ...
  _createClass(CustomHeader, [{
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      if (props.canvasTimeStart !== state.canvasTimeStart || props.canvasTimeEnd !== state.canvasTimeEnd || props.canvasWidth !== state.canvasWidth || props.unit !== state.unit || props.timeSteps !== state.timeSteps || props.showPeriod !== state.showPeriod) {
        var intervals = getHeaderIntervals({
          canvasTimeStart: canvasTimeStart,
          canvasTimeEnd: canvasTimeEnd,
          canvasWidth: canvasWidth,
